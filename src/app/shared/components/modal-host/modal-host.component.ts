import { Component, ViewChild, ViewContainerRef, ComponentRef, inject, OnInit, OnDestroy, AfterViewInit, ChangeDetectorRef, ChangeDetectionStrategy } from '@angular/core';
